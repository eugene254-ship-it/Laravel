...
Route::get('HR/jobs', [App\Http\Controllers\AddjobController::class, 'addJob'])->middleware('auth')->name('HR/jobs');
Route::post('HR/jobs/AddJob', [App\Http\Controllers\AddjobController::class, 'saveJob'])->middleware('auth')->name('HR/jobs/AddJob');